...
func (c *calculationServiceClient) Calculation(ctx context.Context, in *CalculationRequest, opts ...grpc.CallOption) (*CalculationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/calculate.CalculationService/Calculation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCalculationServiceServer) Calculation(context.Context, *CalculationRequest) (*CalculationResponse, error) {
...
func _CalculationService_Calculation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculate.CalculationService/Calculation",
	}
...
var CalculationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "calculate.CalculationService",
